            ...
            if (AICounter++ > 90)
            {
                ...
                if (Shockwave)
                {
                    ...
                    if (MiscCounter2 == 125)
                    {
                        ...
                        Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, NPC.DirectionTo(RotationCenter) * 2, ModContent.ProjectileType<BarrierWave>(), 50, 0f, Main.myPlayer);
