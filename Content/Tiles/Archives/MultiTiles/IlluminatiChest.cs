...
{
    public class IlluminatiChest : ModTile
    {
    ...
    public class IlluminatiChest_TE : ModTileEntity
    {
        ...
        public override bool IsTileValidForEntity(int x, int y)
        {
            ...
            if (!tile.HasTile || tile.TileType != ModContent.TileType<IlluminatiChest>())
            {
                Kill(Position.X, Position.Y);
            }

            return tile.HasTile && tile.TileType == ModContent.TileType<IlluminatiChest>();
        }
    }
}