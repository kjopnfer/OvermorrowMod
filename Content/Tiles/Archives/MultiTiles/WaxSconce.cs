...
namespace OvermorrowMod.Content.Tiles.Archives
{
    ...
    /// <summary>
    /// Secondary variant of the Sconce that has an even width.
    /// </summary>
    public class WaxSconceEven : ModTile
    {
        public override string Texture => AssetDirectory.ArchiveTiles + Name;
        public override bool CanExplode(int i, int j) => false;
        public override void SetStaticDefaults()
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            if (tile.TileFrameX == 0 && tile.TileFrameY == 0 && !Main.gamePaused)
            {
                ...
                WaxCandleholder.CreateEmberParticle(new Vector2(i + 0.45f, j + 0.6f) * 16, velocity, scale);
                WaxCandleholder.CreateEmberParticle(new Vector2(i + 1.55f, j + 0.5f) * 16, velocity, scale);
            }
        }
    }
}