...
namespace OvermorrowMod.Content.Tiles.Ores
{
    public class ManaStone : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(ModContent.GetTexture(AssetDirectory.Tiles + "Ores/ManaStone_Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y + 2) + zero,
