...
namespace OvermorrowMod.Content.Tiles.UVBiome.UVAmbient
{
    public class UV3x5CrystalItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = TileType<UV3x5Crystal>();
        }
    }
    public class UV3x5Crystal : ModTile
    {
        public override void SetStaticDefaults()
        {
            int[] UVMultiTiles = { Type, 5, 18 /*16 but padding*/ };
