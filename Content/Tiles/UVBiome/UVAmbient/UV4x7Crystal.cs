...
namespace OvermorrowMod.Content.Tiles.UVBiome.UVAmbient
{
    public class UV4x7CrystalItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = TileType<UV4x7Crystal>();
        }
    }
    public class UV4x7Crystal : ModTile
    {
        public override void SetStaticDefaults()
        {
            int[] UVMultiTiles = { Type, 7, 18 /*16 but padding*/ };
