...
namespace OvermorrowMod.Content.Tiles.UVBiome.UVAmbient
{
    public class UV2x2CrystalItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = TileType<UV2x2Crystal>();
        }
    }
    public class UV2x2Crystal : ModTile
    {
        public override void SetStaticDefaults()
        {
            int[] UVMultiTiles = { Type, 2, 18 /*16 but padding*/ };
