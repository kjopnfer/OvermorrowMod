...
namespace OvermorrowMod.Content.Tiles.UVBiome.UVAmbient
{
    public class uvStatue1Item : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = TileType<uvStatue1>();
        }
    }
    public class uvStatue1 : ModTile
    {
        public override void SetStaticDefaults()
        {
            int[] UVMultiTiles = { Type, 3, 18 /*16 but padding*/ };
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Request<Texture2D>("OvermorrowMod/Content/Tiles/UVBiome/UVAmbient/uvStatue1Glow").Value, pos + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, 16), Color.White);
        }
    }
}