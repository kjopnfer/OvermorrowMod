...
namespace OvermorrowMod.Content.Items.Archives.Weapons
{
    public class Patronus : ModProjectile, IDrawAdditive
    {
        ...
        private void UpdateTrail()
        {
            ...
            // Gradually increase trail length up to maximum
            if (trailPositions.Count < MAX_TRAIL_LENGTH)
            {
                // Trail grows over time - don't remove anything yet
                return;
            }
        ...
        private void DrawEyeTrail(Vector2 center, Texture2D texture, Color startColor, Color endColor, int trailLength = -1, float segmentSpacing = 5f, float baseWidth = 32f)
        {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            DrawEyeTrail(Projectile.Center + offset, ModContent.Request<Texture2D>(AssetDirectory.Textures + "circle_05").Value, new Color(108, 108, 224),
            ...
            for (int _ = 0; _ < 2; _++)
                DrawEyeTrail(Projectile.Center + offset, trailTexture, Color.White, Color.MediumPurple, trailLength: 100, segmentSpacing: 16f, baseWidth: 70f);
