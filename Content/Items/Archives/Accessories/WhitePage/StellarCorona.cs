        ...
        public override void AI()
        {
            ...
            if (AICounter % 10 == 0)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    ParticleManager.CreateParticleDirect(lightRay, npc.Center, Vector2.Zero, Color.White, 1f, randomSize, randomRotation, ParticleDrawLayer.BehindNPCs); // Scale of 3f becomes the max height
                }
            }
        }
