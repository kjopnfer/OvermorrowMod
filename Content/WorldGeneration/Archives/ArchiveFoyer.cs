...
namespace OvermorrowMod.Content.WorldGeneration.Archives
{
    public class ArchiveFoyer : GrandArchiveRoom
    {
        ...
        public override void PostGenerate(int x, int y)
        {
            ...
            WorldGen.PlaceObject(x + 228, y + 231, ModContent.TileType<WoodenArchSmall>());
            ...
            WorldGen.PlaceObject(x + 251, y + 231, ModContent.TileType<WoodenArchSmall>());
            ...
            WorldGen.PlaceObject(x + 446, y + 67, ModContent.TileType<WaxChandelier>());
