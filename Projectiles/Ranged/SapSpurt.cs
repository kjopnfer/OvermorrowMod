...
namespace OvermorrowMod.Projectiles.Ranged
{
    public class SapSpurt : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num1110 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 153, projectile.velocity.X, projectile.velocity.Y, 50, default, 2f);
            ...
            {
                int num1106 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 152, projectile.velocity.X, projectile.velocity.Y, 50, default, 0.4f);
                switch (num1103)
                {
                    case 0:
