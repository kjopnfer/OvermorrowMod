...
{
    public class ChainKnifeProjectile : PiercingProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Chain Knife");
        }
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[0] == 0f)
            {
                ...
                else if (num501 > 200f) // Projectile's max length
                {
                    projectile.ai[0] = 1f;
                    projectile.netUpdate = true;
                }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D chainTexture = mod.GetTexture("Projectiles/Piercing/ChainKnifeChain");
