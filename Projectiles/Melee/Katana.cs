...
namespace OvermorrowMod.Projectiles.Melee
{
    public class Katana : HeldSword
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D slash = ModContent.GetTexture("OvermorrowMod/Textures/trace_01");
            ...
            Texture2D texture2D16 = mod.GetTexture("Projectiles/Melee/Katana_Afterimage2");
