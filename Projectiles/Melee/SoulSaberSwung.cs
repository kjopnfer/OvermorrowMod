...
namespace OvermorrowMod.Projectiles.Melee
{
    public class SoulSpin : ModProjectile, ITrailEntity
    {
        ...
        public override string Texture => "OvermorrowMod/Items/Weapons/PreHardmode/Melee/SoulSaber";
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D chainTexture = ModContent.GetTexture("OvermorrowMod/Projectiles/Piercing/BonePiercerChain");
