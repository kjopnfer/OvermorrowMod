...
{
    public class MushAxeProj : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            for (float k = 0; k <= length; k += 20f)
            {
                ...
                spriteBatch.Draw(chainTexture, drawPos, null, alpha, (Main.player[projectile.owner].Center - projectile.Center).ToRotation(), new Vector2(5f * 1.3f, 5f * 1.3f), 1f, SpriteEffects.None, 0f);
            }
            return true;
        }
    }
