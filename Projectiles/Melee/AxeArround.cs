...
{
    public class AxeArround : ModProjectile
    {
        private const string ChainTexturePath = "OvermorrowMod/Projectiles/Melee/AxeChain";
        int okay1 = 0;
        int okay2 = 0;
        ...
        public override void AI()
        {
            ...
            if (okay1 > 0)
            {
                ...
                projectile.position.X = 75 * (float)Math.Cos(projectile.rotation) + Main.player[projectile.owner].Center.X - 22f;
                projectile.position.Y = 75 * (float)Math.Sin(projectile.rotation) + Main.player[projectile.owner].Center.Y - 22f;
