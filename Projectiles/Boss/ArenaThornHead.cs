...
{
    public class ArenaThornHead : ModProjectile
    {
        ...
        public override string Texture => "OvermorrowMod/Projectiles/Boss/ThornHead";
        ...
        public override void AI()
        {
            ...
            else // Start spawning the projectile
            {
                ...
                {
                    if (Main.npc[parentNPC].active && Main.npc[parentNPC].boss)
                    {
