...
namespace OvermorrowMod.Projectiles.Magic
{
    public class LightningArc : Lightning
    {
        ...
        public override void AI()
        {
            ...
            {
                Positions = Lightning.CreateLightning(Main.npc[(int)projectile.ai[0]].Center, Main.npc[(int)projectile.ai[1]].Center, projectile.width, 20, 8f);
            }
            else if (projectile.ai[1] == -1)
            {
                Positions = Lightning.CreateLightning(Main.player[projectile.owner].Center, Main.npc[(int)projectile.ai[0]].Center, projectile.width, 20, 8f);
            }
