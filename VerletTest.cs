        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            if (NPC.ai[0] == 0)
            {
                ...
                */
                ...
                points = GenerateVerlet(texture, NPC.Center, NPC.Center + new Vector2(-200, 240), true, false);
                points2 = VerletPointsInLine_Offset(new Vector2(NPC.Center.X - 300, NPC.Center.Y - 400), new Vector2(NPC.Center.X + 300, NPC.Center.Y - 400), new float[] { 0f, 0.3f, .3f, .7f, 1f }, 5, true, true);
            ...
            NPC.ai[0]++;
            DrawVerlet(points, DustID.GemEmerald, Color.White, spriteBatch);
