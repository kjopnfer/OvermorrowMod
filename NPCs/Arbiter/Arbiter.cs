...
namespace OvermorrowMod.NPCs.Arbiter
{
	internal class ArbiterHead : Arbiter
	{
		public override string Texture => "OvermorrowMod/NPCs/Arbiter/Arbiter_Head";
	...
	{
		public override string Texture => "OvermorrowMod/NPCs/Arbiter/Arbiter_Body";
		public override void SetDefaults()
		{
