...
namespace OvermorrowMod.NPCs.Bosses.StormDrake
{
    public class LaserWarning : Deathray
    {
        ...
        public LaserWarning()  : base(300 + wait, 2500 + (wait / 10), 0f, Color.Blue, "NPCs/Bosses/StormDrake/LaserWarning") { }
        ...
        public override void AI()
        {
            ...
            float length = (TRay.Cast(projectile.Center, projectile.velocity, 2500f) - projectile.Center).Length();
            LaserLength = length;
