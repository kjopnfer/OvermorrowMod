...
namespace OvermorrowMod.NPCs.Bosses.StormDrake
{
    public class LaserWarning2 : Deathray
    {
        ...
        public LaserWarning2() : base(50, 2500, 0f, Color.Blue, "NPCs/Bosses/StormDrake/LaserWarning") { }
        public override bool CanHitPlayer(Player target) => false;
        public override bool? CanHitNPC(NPC target) => false;
        public override void AI()
        {
            float length = (TRay.Cast(projectile.Center, projectile.velocity, 2000f) - projectile.Center).Length();
            LaserLength = length;
