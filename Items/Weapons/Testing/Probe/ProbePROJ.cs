        ...
        public override void AI()
        {
            ...
            if (Main.player[projectile.owner].channel && foundTarget)
            {
                ...
                if (timer == 45 + Random2)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, newpoint2.X * speed, newpoint2.Y * speed, mod.ProjectileType("ProbeLaser"), projectile.damage, 1f, projectile.owner, 0f);
                    timer = 0;
                }
            }
        }
