...
namespace OvermorrowMod.Items.Weapons.PreHardmode.Melee
{
    public class Katana : ModItem
    {
        ...
        public override string Texture => "OvermorrowMod/Items/Weapons/PreHardmode/Melee/Katana";
        ...
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = ModContent.ProjectileType<Projectiles.Melee.Katana>();
        }
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            ...
            Texture2D spot = ModContent.GetTexture("OvermorrowMod/Textures/Spotlight");
            float alpha = 0.8f;
            float s = 0.5f * scale;
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            Texture2D texture = Main.itemTexture[item.type];
            Texture2D flash = ModContent.GetTexture("OvermorrowMod/Textures/Flash2");
            spriteBatch.Reload(BlendState.Additive);
