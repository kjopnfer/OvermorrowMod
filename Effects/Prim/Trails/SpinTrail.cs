    ...
    public class SpinTrail : Trail
    {
        ...
        public override void PrepareTrail()
        {
            ...
            for (int i = 0; i < Positions.Count - 1; i++)
            {
                ...
                Vector2 off1 = PrimitiveHelper.GetRotation(Positions.ToArray(), i) * TrailEntity.TrailSize(prog1) * /*(prog1 * 0.1f + 0.9f)*/ (1 - prog1);
                Vector2 off2 = PrimitiveHelper.GetRotation(Positions.ToArray(), i + 1) * TrailEntity.TrailSize(prog2) * /*(prog2 * 0.1f + 0.9f)*/ (1 - prog2);
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            Effect.SafeSetParameter("uImage0", OvermorrowModFile.Mod.GetTexture("Effects/TrailTextures/ShiroTrail"));
