...
namespace OvermorrowMod.Effects.Prim
{
    public class SoulTrail : Trail
    {
        public override void SetDefaults()
        {
            ...
            Color = Color.Green;//Color.LightCyan;
            Pixelated = false;
        }
        ...
        public override void PrepareEffect()
        {
            ...
            Main.graphics.GraphicsDevice.Textures[0] = OvermorrowModFile.Mod.GetTexture("Effects/Trail3");
        ...
        public override void PrepareTrail()
        {
            ...
            for (int i = 0; i < Positions.Count - 1; i++)
            {
                ...
                Color col1 = Color.Lerp(Color.Cyan, Color.White, prog1) * prog1;
                Color col2 = Color.Lerp(Color.Cyan, Color.White, prog2) * prog2;
