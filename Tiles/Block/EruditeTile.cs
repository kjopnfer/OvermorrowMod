...
namespace OvermorrowMod.Tiles.Block
{
    public class EruditeTile : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(mod.GetTexture("Tiles/Block/EruditeTile_Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y + 2) + zero,
