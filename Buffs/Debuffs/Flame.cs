...
namespace OvermorrowMod.Buffs.Debuffs
{
    public class Flame : ModBuff
    {
        ...
        public override void Update(NPC npc, ref int buffIndex)
        {
            ...
            for (int i = 0; i < 3; i++)
                Particle.CreateParticle(Particle.ParticleType<Glow1>(), npc.position + new Vector2(size.X * Main.rand.NextFloat(), size.Y * Main.rand.NextFloat()), Vector2.Zero, new Color(0.4f, 0.2f, 0.01f), 1f, Main.rand.NextFloat(0.7f, 1.3f), 0, Main.rand.Next(20, 30));
        }
