...
//    {
//        public Color color;
//        public List<Projectiles.LightningSegment> segments = new List<Projectiles.LightningSegment>();
//        public List<Projectiles.LightningSegment> previousSegments = new List<Projectiles.LightningSegment>();
...
//            var seg = Utils.CreateLightning(from, to, delegate (float progress) {return baseSize * (1f - progress);}, segDiv, sway);
//            segments = seg.Item1;
//            lengths = seg.Item2;
//        }
...
//    {
//        public override string Texture => "TestMod/Textures/Empty";
