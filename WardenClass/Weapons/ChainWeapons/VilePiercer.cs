    ...
    public class VilePiercer : PiercingItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("[c/09DBB8:{ Imbuement }]\n" +
                ...
                "[c/DE3A28:{ Power }] Your Artifact summons inflict [c/00FF00:Emerald Hex], dealing damage over time\n" +
                "Additionally, spawns Cursed Fireballs on enemy hits which chase down nearby enemies\n" +
