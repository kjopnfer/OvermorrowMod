        ...
        public override void CreateTilePile()
        {
            switch (Main.rand.Next(4))
            {
                case 0:
                    ...
                    PileContents[0] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 16, 38, -1, (int)TileInfo.InteractionType.Click);
                    PileContents[1] = new TileInfo(TileObjects.ObjectType<Crate_M>(), position, 18, 28, 0, (int)TileInfo.InteractionType.Chop);
                    break;
                case 1:
                    PileContents = new TileInfo[4];
                    PileContents[0] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 4, 32, -1, (int)TileInfo.InteractionType.Click);
                    PileContents[1] = new TileInfo(TileObjects.ObjectType<Crate_M>(), position, 18, 28, -1, (int)TileInfo.InteractionType.Chop);
                    PileContents[2] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 18, 26, 1, (int)TileInfo.InteractionType.Mine);
                    PileContents[3] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 24, 14, 2, (int)TileInfo.InteractionType.Click);
                    break;
                case 2:
                    PileContents = new TileInfo[4];
                    PileContents[0] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 18, 32, -1, (int)TileInfo.InteractionType.Click);
                    PileContents[1] = new TileInfo(TileObjects.ObjectType<Crate_M>(), position, 18, 30, 0, (int)TileInfo.InteractionType.Mine);
                    PileContents[2] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 22, 18, 1, (int)TileInfo.InteractionType.Click);
                    PileContents[3] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 4, 30, -1, (int)TileInfo.InteractionType.Chop);
                    break;
                case 3:
                    PileContents = new TileInfo[3];
                    PileContents[0] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 6, 32, -1, (int)TileInfo.InteractionType.Click);
                    PileContents[1] = new TileInfo(TileObjects.ObjectType<Crate_M>(), position, 8, 14, 0, (int)TileInfo.InteractionType.Mine);
                    PileContents[2] = new TileInfo(TileObjects.ObjectType<Crate_S>(), position, 26, 34, -1, (int)TileInfo.InteractionType.Chop);
                    break;
                    /*case 0:
                        PileContents = new TileInfo[2];
