...
namespace OvermorrowMod.Common.Configs
{
    public class AmmoSwapConfig : ModConfig
    {
        ...
        [Header("AmmoQuickswapPosition")] // Headers are like titles in a config. You only need to declare a header on the item it should appear over, not every item in the category.
